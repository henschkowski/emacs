...

;;;### (autoloads nil "highlight-chars" "highlight-chars.el" (23403
;;;;;;  64790 478805 646000))
...
(autoload 'hc-remove-if "highlight-chars" "\
A copy of list XS with no elements that satisfy predicate PRED.

\(fn PRED XS)" nil nil)

(autoload 'hc-remove-hc-from-font-lock-keywords "highlight-chars" "\
Remove `hc-*' face entries from `font-lock-keywords' in current buffer.

\(fn)" nil nil)

(defvar hc-font-lock-override 'append "\
...
(custom-autoload 'hc-font-lock-override "highlight-chars" nil)
